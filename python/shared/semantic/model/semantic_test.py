...
Cases = {
    ...
    "enabled": [
        ...
        { "phrase": u"wie ist das internet im flur", "items": [["pGF_Corridor_Speedtest_Ping","READ"],["pGF_Corridor_Speedtest_Server","READ"],["pGF_Corridor_Fritzbox_WanAccessType","READ"],["pGF_Corridor_Fritzbox_WanPhysicalLinkStatus","READ"],["pGF_Corridor_Fritzbox_WanUpstreamCurrRate","READ"],["pGF_Corridor_Fritzbox_WanDownstreamCurrRate","READ"],["pGF_Corridor_Fritzbox_GuestWifi","READ"],["pGF_Corridor_Speedtest_UpstreamRate","READ"],["pGF_Corridor_Speedtest_Start","READ"],["pGF_Corridor_Fritzbox_Uptime","READ"],["pGF_Corridor_Speedtest_DownstreamRate","READ"]] },
